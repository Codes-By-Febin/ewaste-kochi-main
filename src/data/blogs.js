...
export const blogs = [
  ...
  {
    slug: 'infopark-it-manager-checklist',
    title: 'Audit-Ready: A 5-Point Checklist for IT Managers in Infopark Before Disposing of Company Laptops',
    category: 'itad',
    excerpt: 'Prepare your next IT refresh for success. This 5-point checklist ensures your Infopark firm meets NIST standards and DPDP Act requirements during asset disposal...',
    content: `<h2>Pre-Disposal Checklist for Infopark IT Teams</h2><p>1. <strong>Asset Tag Verification</strong> — Scan all internal tags against the master inventory. 2. <strong>Data Classification</strong> — Identify devices containing PII or financial data. 3. <strong>Standard Selection</strong> — Choose between NIST 800-88 Purge or physical shredding. 4. <strong>Logistics Security</strong> — Ensure the transport vehicle is GPS-tracked. 5. <strong>Certificate Reconciliation</strong> — Match the Certificate of Destruction serials against your initial scan.</p>`,
    date: '2026-04-10',
    author: 'Operations Team, EWaste Kochi',
    keywords: ['Infopark IT asset disposal', 'itad checklist kochi', 'corporate laptop disposal guide'],
  },
  {
    slug: 'ewaste-kochi-scam-alert',
    title: 'The Hidden Cost of Free Pickup: Why Some Kochi Scrap Dealers Dump Your Data in the Backwaters',
    category: 'compliance',
    excerpt: 'Not every "free pickup" is safe. Unauthorized scrap dealers in Kochi often ignore data security, leading to data breaches and environmental contamination. Here is what to watch for...',
    content: `<h2>Scrap Dealers vs. Authorized Recyclers</h2><p>Informal dealers often strip valuable metals using acid baths and discard data-bearing plates in landfills or Kochi's waterways. This leaves your company liable for data breaches and environmental fines under the 2022 rules.</p>`,
    date: '2026-04-05',
    author: 'Compliance Team, EWaste Kochi',
    keywords: ['ewaste kochi scam', 'authorized vs unauthorized recycler', 'data breach risk kochi'],
  },
  {
    slug: 'kspcb-form-3-filing-guide',
    title: 'Understanding the KSPCB Form 3: What You Need to File as a Bulk Consumer in Kerala',
    category: 'compliance',
    excerpt: 'Filing your annual e-waste return is mandatory for all Kochi businesses with IT assets over ₹10 Lakh. Learn how to complete Form 3 accurately and on time...',
    content: `<h2>Filing Form 3 in Ernakulam</h2><p>The annual return must summarize the e-waste generated and channeled to authorized recyclers. Using an authorized partner like us makes this easy, as we provide the exact weights and manifests required for the filing.</p>`,
    date: '2026-03-20',
    author: 'Compliance Team, EWaste Kochi',
  },
  {
    slug: 'kerala-ewaste-statistics-2026',
    title: 'Kerala E-Waste Statistics 2026: 18,000 Tonnes Generated Annually in Kochi Hub',
    category: 'environment',
    excerpt: 'Our latest data analysis reveals that Ernakulam district now accounts for 45% of Kerala\'s total electronic waste. Explore the trends in urban mining and metal recovery for 2026...',
    content: `<h2>The State of E-Waste in Kerala</h2><p>In 2026, Kerala\'s per capita e-waste generation has surpassed the national average. Kochi remains the primary hub, fueled by the rapid hardware turnover in Infopark and Smart City.</p><h3>Regional Breakdown</h3><p>Ernakulam: 18.2k Tonnes; Thiruvananthapuram: 12.1k Tonnes; Kozhikode: 8.5k Tonnes.</p>`,
    date: '2026-04-15',
    author: 'Research Team, EWaste Kochi',
    keywords: ['kerala ewaste statistics', 'electronic waste generation india 2026', 'recycling data kochi'],
  },
];
